...
def generate_maximum(l):
    """
    Generates the maximum number that can be constructed using the digits of a number, represented as a list of
    existences.
...
def print_maximum(n):
    ...
    :return: None
    """
    print("The maximum number formed with the digits is: ", n)
...
def main():
    ...
    print(result_list)
    n = generate_maximum(result_list)
    print_maximum(n)
