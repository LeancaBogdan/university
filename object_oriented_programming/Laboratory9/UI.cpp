...
#pragma region user
void UI::printUserMainMenu()
{
	std::cout << "Options: \n";
	std::cout << "\t1. Populate basket.\n";
	std::cout << "\t2. Open basket in application.\n";
...
void UI::printUserMenu()
{
	...
	std::cout << "\t2. Next.\n";
	std::cout << "\t3. See coats in the basket.\n";
}
...
void UI::userMenu()
{
	while (1)
	{
		...
		std::stringstream str2(input);
		str2 >> option;
		while (!str2 && option < 0 || option > 2)
		{
			std::cout << "You need to provide an integer between 0 and 2!\nTry again: ";
			std::cin >> input;
			std::stringstream str2(input);
		}
		system("CLS");
